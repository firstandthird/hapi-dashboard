...
module.exports = function(plugin, options, next) {
  ...
  plugin.route([
    ...
    { path: options.endpoint + '/{name}', method: 'GET', config: dashboardConf},
    { path: options.endpoint + '/{name}.csv', method: 'GET', config: dashboardConf },
    { path: options.endpoint + '/{name}.json', method: 'GET', config: dashboardConf }
  ]);
